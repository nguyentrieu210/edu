...
const staticItems = [
  ...
  { id: 'p-tportal',     label: 'Cổng Giáo viên',          subtitle: 'Lịch dạy & lớp của tôi', emoji: '🧑‍🏫', badge: 'Portal', action: () => router.push('/teacher-portal') },
  { id: 'p-sportal',     label: 'Cổng Học viên',           subtitle: 'Tiến độ, điểm, bài tập, công nợ', emoji: '🎓', badge: 'Portal', action: () => router.push('/student-portal') },
